...
UE.I18N['zh-TW'] = {
    'labelMap':{
        ...
        'mergecells':'合並多個單元格', 'deletetable':'刪除表格', 'cleardoc':'清空文檔','insertparagraphbeforetable':"表格前插入行",'insertcode':'代碼語言','fontfamily':'字體', 'fontsize':'字號', 'paragraph':'段落格式', 'insertimage':'圖片',
    ...
    'contextMenu':{
        ...
        'copy':"復制(Ctrl + c)",
        'copymsg':"請使用 'Ctrl + c'執行復制操作",
        'paste':"粘貼(Ctrl + v)",
         'pastemsg':"請使用 'Ctrl + v'執行復制操作",
        'highlightcode':'插入代碼'
    },
    ...
    'insertimage':{
        ...
        'floatCenter':"居中",
        'flashI18n':{
            lang:encodeURI( '{"UploadingState":"總數: ${a},上傳成功: ${b}", "BeforeUpload":"${a}張圖片等待上傳", "ExceedSize":"${a}張圖片大小超出限制", "ErrorInPreview":"預覽失敗", "DefaultDescription":"請輸入描述", "LoadingImage":"加載中..."}' ),
